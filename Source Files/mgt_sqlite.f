      subroutine mgt_sqlite(id_op,id_hru)
        ...
        select case (id_op)
            ...
            case (5) !! harvest and kill operation
                ...
                call sqlite3_set_column( colmgt(14), yield(j) )
            ...
            case (7) !!Harvest only
                ...
                call sqlite3_set_column( colmgt(28), yieldgrn(j) )
                call sqlite3_set_column( colmgt(29), yieldbms(j) )
                call sqlite3_set_column( colmgt(30), yieldtbr(j) )
                call sqlite3_set_column( colmgt(31), yieldrsd(j) )
                call sqlite3_set_column( colmgt(32), yieldn(j) )
                call sqlite3_set_column( colmgt(33), yieldp(j) )
            case (8) !!kill
